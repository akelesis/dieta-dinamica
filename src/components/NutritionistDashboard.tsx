...
const reproductiveStatusLabel: Record<string, string> = { none: 'Não se aplica', pregnant_first_trimester: 'Gestante · 1º trimestre', pregnant_second_trimester: 'Gestante · 2º trimestre', pregnant_third_trimester: 'Gestante · 3º trimestre', breastfeeding_0_6_months: 'Amamentando · bebê de até 6 meses', breastfeeding_7_12_months: 'Amamentando · bebê de 7 a 12 meses' }
